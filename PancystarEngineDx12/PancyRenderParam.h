...
namespace PancystarEngine
{
	class BasicRenderParam
	{
		...
		//渲染所需的描述符数据
		std::unordered_map<std::string, PancystarEngine::BindDescriptorPointer> globel_constant_buffer;       //全局常量缓冲区
		std::unordered_map<std::string, PancystarEngine::BindDescriptorPointer> private_constant_buffer;      //私有常量缓冲区
		std::unordered_map<std::string, PancystarEngine::BindDescriptorPointer> globel_shader_resource;       //全局描述符
		std::unordered_map<std::string, PancystarEngine::BindDescriptorPointer> bind_shader_resource;         //私有描述符
		std::unordered_map<std::string, PancystarEngine::BindlessDescriptorPointer> bindless_shader_resource; //解绑定描述符

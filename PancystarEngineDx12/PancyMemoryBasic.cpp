...
SubresourceControl::SubresourceControl()
{
	...
	//资源状态
	JSON_REFLECT_INIT_ENUM(D3D12_RESOURCE_STATE_COMMON);
	JSON_REFLECT_INIT_ENUM(D3D12_RESOURCE_STATE_VERTEX_AND_CONSTANT_BUFFER);
	JSON_REFLECT_INIT_ENUM(D3D12_RESOURCE_STATE_INDEX_BUFFER);
	JSON_REFLECT_INIT_ENUM(D3D12_RESOURCE_STATE_RENDER_TARGET);
	JSON_REFLECT_INIT_ENUM(D3D12_RESOURCE_STATE_UNORDERED_ACCESS);
	JSON_REFLECT_INIT_ENUM(D3D12_RESOURCE_STATE_DEPTH_WRITE);
	JSON_REFLECT_INIT_ENUM(D3D12_RESOURCE_STATE_DEPTH_READ);
	JSON_REFLECT_INIT_ENUM(D3D12_RESOURCE_STATE_NON_PIXEL_SHADER_RESOURCE);
	JSON_REFLECT_INIT_ENUM(D3D12_RESOURCE_STATE_PIXEL_SHADER_RESOURCE);
	JSON_REFLECT_INIT_ENUM(D3D12_RESOURCE_STATE_STREAM_OUT);
	JSON_REFLECT_INIT_ENUM(D3D12_RESOURCE_STATE_INDIRECT_ARGUMENT);
	JSON_REFLECT_INIT_ENUM(D3D12_RESOURCE_STATE_COPY_DEST);
	JSON_REFLECT_INIT_ENUM(D3D12_RESOURCE_STATE_COPY_SOURCE);
	JSON_REFLECT_INIT_ENUM(D3D12_RESOURCE_STATE_RESOLVE_DEST);
	JSON_REFLECT_INIT_ENUM(D3D12_RESOURCE_STATE_RESOLVE_SOURCE);
	JSON_REFLECT_INIT_ENUM(D3D12_RESOURCE_STATE_GENERIC_READ);
	JSON_REFLECT_INIT_ENUM(D3D12_RESOURCE_STATE_PRESENT);
	JSON_REFLECT_INIT_ENUM(D3D12_RESOURCE_STATE_PREDICATION);
	JSON_REFLECT_INIT_ENUM(D3D12_RESOURCE_STATE_VIDEO_DECODE_READ);
	JSON_REFLECT_INIT_ENUM(D3D12_RESOURCE_STATE_VIDEO_DECODE_WRITE);
	JSON_REFLECT_INIT_ENUM(D3D12_RESOURCE_STATE_VIDEO_PROCESS_READ);
	JSON_REFLECT_INIT_ENUM(D3D12_RESOURCE_STATE_VIDEO_PROCESS_WRITE);
	//资源格式demention

...
#include <assimp/postprocess.h>     // и�ͷ�ļ��а����ı�־λ���
...
{
	std::string bone_name;                              //ݱ��α任��ݶ�Ӧ�Ĺ�����
	skin_tree *bone_point;                              //Ʊ��α任��ݶ�Ӧ�Ĺ����ָ�
	std::vector<vector_animation> translation_key;      //���ƽ�Ʊ任��
	std::vector<vector_animation> scaling_key;          //ݸ�����任��
	std::vector<quaternion_animation> rotation_key;     //ݸ����ת�任����
};
struct animation_set
{
	float animation_length;                             //ݶ����ĳ��
	std::vector<animation_data> data_animition;         //ȸö�������
};
class PancySubModel
{
...
{
	//���ʱ��Ⱦ���(ģ�ʹ�����������ֻ����һ��ģ�ͣ����view����renderobjͷ�װ����ʽʹ�û��viewл����)
	...
	animation_set now_animation_use;//��ǰ����ʹ�õĶ���
...
{
	//dx11�ӿ(����ڽ��bc6/7�����gpu�ѹ���΢�������dx12��µbc7�ѹ�������)
